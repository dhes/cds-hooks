...
function extractPrefetchFromELM(elm) {
  ...
  prefetch["Procedure"] = "Procedure?patient={{context.patientId}}",
  prefetch["Condition"] = "Condition?patient={{context.patientId}}",
  prefetch["ServiceRequest"] = "ServiceRequest?patient={{context.patientId}}",
  prefetch["Observation"] = "Observation?patient={{context.patientId}}&code=http://loinc.org|72166-2" 
  console.log()
  return prefetch;
}
